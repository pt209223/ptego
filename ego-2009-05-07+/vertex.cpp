...
// TODO make this constructor a static function
Vertex::Vertex (uint row, uint col) {
...
Vertex Vertex::NN() const { return Vertex (idx - 2*dNS); }
Vertex Vertex::WW() const { return Vertex (idx - 2*dWE); }
Vertex Vertex::EE() const { return Vertex (idx + 2*dWE); }
Vertex Vertex::SS() const { return Vertex (idx + 2*dNS); }
